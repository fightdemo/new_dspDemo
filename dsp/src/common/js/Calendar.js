...
function Calendar(beginYear, endYear, language, patternDelimiter, date2StringPattern, string2DatePattern) {
	...
	this.colors = {"bg_cur_day":"#009cf9","bg_over":"#fff","bg_out":"#009cf9"}
};
...
Calendar.prototype.draw = function() {
	...
	_cs[_cs.length] = ' <\/tr>';
	_cs[_cs.length] = ' <tr style="border-bottom: 1px solid red">';
	for(var i = 0; i < 7; i++) {
	...
	_cs[_cs.length] = ' <tr style="display: none;">';
	...
	for(var i = 0; i < tds.length; i++) {
		...
		if (dateArray[i]){
			...
			tds[i].onmouseout  = function () {
				...
				this.style.color = "#595853";
			};
			if (today.getFullYear() == calendar.date.getFullYear()) {
				if (today.getMonth() == calendar.date.getMonth()) {
					if (today.getDate() == dateArray[i]) {
						tds[i].style.borderRadius = "5px";
...
document.writeln('<div id="__calendarPanel" style="position:absolute;top:0;visibility:hidden;z-index:9999;background-color:#FFFFFF;border:1px solid #cfccc7; border-radius: 5px; width:260px;height:216px;">');
document.writeln('<iframe name="__calendarIframe" id="__calendarIframe" width="100%" height="100%" scrolling="no" frameborder="0" style="margin:0px; border-radius: 5px;"><\/iframe>');
...
__ci.document.writeln('body {font-size:12px;margin:0px;text-align:center; padding: 15px;}');
__ci.document.writeln('form {margin:0px;}');
__ci.document.writeln('select {font-size:12px;background-color:#fff; color: #595853; height: 26px; border-radius: 3px; border-color: #cfccc7;}');
...
__ci.document.writeln('th.theader {font-weight:normal;background-color:#fff; border-bottom: 1px solid #c3bfb9; color:#595853;width:24px; \}');
__ci.document.writeln('select.year {width:85px; margin-right: 10px;}');
__ci.document.writeln('select.month {width:60px;}');
__ci.document.writeln('td {font-size:12px;text-align:center;}');
__ci.document.writeln('td.sat {background-color:#EFEFEF;}');
__ci.document.writeln('td.sun {background-color:#EFEFEF;}');
__ci.document.writeln('td.normal {background-color:#EFEFEF;}');
__ci.document.writeln('input.l {border: 0 none;background-color:#fff;width:20px;height:20px;}');
__ci.document.writeln('input.r {border: 0 none;background-color:#fff;width:20px;height:20px;}');
__ci.document.writeln('input.b {border: 0 none;background-color:#fff;width:100%;height:20px;}');
__ci.document.writeln('-->');
