<template>
    <div class="nav">
        ...
        <div class="nav-top">
            <div class="logo-box3" v-if="SKIN == 3">
        ...
        <div class="user-box fr cl">
            <div class="user-info fr">
                <span class="ng-binding">新版本测试环境测试</span>
                <i class="icon-arr"></i>
                <ul class="user-list">
                    <li class="user-balance">
                        余额（元）：
                        <span class="fr ng-binding">{{balance|number}}</span>
                    </li>
                    <li class="user-logout">
                        <i class="icon-logout"></i>推出
                    </li>
                </ul>
            </div>
