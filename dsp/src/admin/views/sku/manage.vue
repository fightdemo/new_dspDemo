                        ...
                        <table class="table-box"  id='tableInfo'  style="width:100%;">
                            ...
                            <tbody>
                                <tr v-for="(item,index) in list" :key="index">
                                    ...
                                    <td>{{item.name}}</td>
                                    <td>
                                        <p style="white-space:nowrap;" v-for="data in item.date.split(';')" :key="data">{{data}}</p>
                                    </td>
                                    <td>{{item.platform}}</td>
                                    ...
                                    <td>
                                        <dsp-button v-show="item.executeState != '交易结束' && item.executeState != '已售罄'" class="dsp-btn btn-blue" @click="$router.push({name:'sku.detail',params:{id:item.id}})">修改价格</dsp-button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
